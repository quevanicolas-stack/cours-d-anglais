...
| `module6-seance3.html` | source unique, 7 slides 16:9 — pas encore de PDF exporté. « Handling Objections Like a Pro » : la méthode ACCA (Acknowledge/Clarify/Counter/Act), les 5 objections les plus courantes avec réponses mot à mot sur 2 diapositives, ce qu'il ne faut jamais faire face à une objection. Module 6 est le dernier construit pour l'instant : il en reste 2, en attente du retour d'Aurélie. |
