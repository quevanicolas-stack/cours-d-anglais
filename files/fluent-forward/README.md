...
| `module3-seance3.html` | source unique, 8 slides 16:9 — pas encore de PDF exporté. Le module 3 a 5 séances de contenu au total ; les séances 4 et 5 restent à construire. |
